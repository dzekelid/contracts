...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/contracts/master/_listings/akamai/invoicing-api-v2-contracts-contractid-invoices-year,month-get.md
x-common:
- type: x-base
