...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/contracts/master/_listings/dezrez/apis.md
...
- name: Dezrez.Rezi.Client.Api - Returns the data contract to configure the word plugin
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/contracts/master/_listings/dezrez/apidocumentgenerationmetadatamajorminorbuildrevision-get-openapi.md
- name: Dezrez.Rezi.Client.Api - Get an EventListDataContract by event Id.
  x-api-slug: apilisteventid-get
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/contracts/master/_listings/dezrez/apilisteventid-get-openapi.md
- name: Dezrez.Rezi.Client.Api - Returns the data contract to configure the word plugin
    for creating templates
  x-api-slug: apidocumentgenerationmetadatamajorminorbuildrevision-get
  description: Returns the data contract to configure the word plugin for creating
